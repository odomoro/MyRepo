...
public class ClienteLST extends ListActivity {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        final int rowId = mCursor.getInt( mCursor.getColumnIndex(ClienteDIC.ID));
    ...
    private void incluir() {
        ...
        Intent intent = new Intent(this, ClienteACT.class);
    ...
    private void fillData(String query) {
        ...
        String[] from = new String[] {ClienteDAO.COLUNA_1, ClienteDAO.COLUNA_2};
        int[] to = new int[] { R.id.cliente_coluna_1, R.id.cliente_coluna_2 };
        SimpleCursorAdapter cursor =
              new SimpleCursorAdapter( this, R.layout.cliente_lista_linha, mCursor, from, to, 0 );
